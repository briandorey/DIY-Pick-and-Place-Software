...
namespace PickandPlaceV2
{
    public class Kflop
    {
        ...
        //KflopAxis AxisY = new KflopAxis(5000, 500000000, 510);
        ...
        public void InitDeviceSettings()
        {
            ...
            */
            ...
            //_Controller.CoordMotion.MotionParams.MaxAccelZ = 4000;
            //_Controller.CoordMotion.MotionParams.MaxAccelA = 4000;
            ...
            //_Controller.CoordMotion.MotionParams.MaxVelZ = 5000;
            //_Controller.CoordMotion.MotionParams.MaxVelA = 5000;
            _Controller.CoordMotion.MotionParams.MaxVelZ = 20000;
        ...
        public bool MoveSingleFeed(double speed, double x, double y, double z, double a, double b, double c)
        {
            ...
            {
                MessageBox.Show("Error with location out of bounds");
                return false;
            }
            else
            {
               ...
               // _Controller.CoordMotion.MotionParams.MaxVelX = 200; ;
               // _Controller.CoordMotion.MotionParams.MaxVelY = 200;
